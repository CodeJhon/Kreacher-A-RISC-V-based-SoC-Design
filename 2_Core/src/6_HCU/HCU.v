...
always @( * ) begin
    ...
    //------------------------------------------------------------------------------ BYPASSING EX STAGE
    //sel_RS1 MUX logic
    if(((EX_RS1_addr == MEM_RD_addr_in)&& (MEM_regfile_we_in == 1'b1)) && (EX_RS1_addr != 5'd0))   
        EX_sel_RS1 = `HCU_BYPASS_MEM;
    else if(((EX_RS1_addr == WB_RD_addr_in)&& (WB_regfile_we_in == 1'b1)) && (EX_RS1_addr != 5'd0))
        EX_sel_RS1 = `HCU_BYPASS_WB;
    else
        EX_sel_RS1 = `HCU_NO_BYPASS;
    //sel_RS2 MUX logic
    if(((EX_RS2_addr == MEM_RD_addr_in)&& (MEM_regfile_we_in == 1'b1)) && (EX_RS2_addr != 5'd0))   
        EX_sel_RS2 = `HCU_BYPASS_MEM;
    else if(((EX_RS2_addr == WB_RD_addr_in)&& (WB_regfile_we_in == 1'b1)) && (EX_RS2_addr != 5'd0))
    ...
    //------------------------------------------------------------------------------ BYPASSING ID STAGE
    //sel_RS1 MUX logic
    if(((ID_RS1_addr == WB_RD_addr_in)&& (WB_regfile_we_in == 1'b1)) && (ID_RS1_addr != 5'd0))
        ID_sel_RS1 = `HCU_BYPASS_WB;
    else
        ID_sel_RS1 = `HCU_NO_BYPASS;
    //sel_RS2 MUX logic
    if(((ID_RS2_addr == WB_RD_addr_in)&& (WB_regfile_we_in == 1'b1)) && (ID_RS2_addr != 5'd0))
...
always @( * ) begin
    ...
    if(EX_csr_addr_rd == `MSTATUS_ADDR || EX_csr_addr_rd == `MEPC_ADDR || EX_csr_addr_rd == `MCAUSE_ADDR) begin
        if((EX_csr_addr_rd == MEM_csr_addr_wr_in) && (MEM_csr_we_in == 1'b1))
            EX_sel_csr_data_rd = `HCU_BYPASS_MEM;
        else if((EX_csr_addr_rd == WB_csr_addr_wr_in) && (WB_csr_we_in == 1'b1))
    ...
    if(ID_csr_addr_rd == `MSTATUS_ADDR || ID_csr_addr_rd == `MEPC_ADDR || ID_csr_addr_rd == `MCAUSE_ADDR) begin
        if((ID_csr_addr_rd == WB_csr_addr_wr_in) && (WB_csr_we_in == 1'b1))
